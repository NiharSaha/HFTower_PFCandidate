...
phfCoincFilter1Th2 = phfCoincFilter2Th4.clone(threshold = 2, minnumtowers = 1)
phfCoincFilter2Th2 = phfCoincFilter2Th4.clone(threshold = 2, minnumtowers = 2)
phfCoincFilter3Th2 = phfCoincFilter2Th4.clone(threshold = 2, minnumtowers = 3)
phfCoincFilter4Th2 = phfCoincFilter2Th4.clone(threshold = 2, minnumtowers = 4)
phfCoincFilter5Th2 = phfCoincFilter2Th4.clone(threshold = 2, minnumtowers = 5)
...
phfCoincFilter1Th4 = phfCoincFilter2Th4.clone(threshold = 4, minnumtowers = 1)
phfCoincFilter2Th4 = phfCoincFilter2Th4.clone(threshold = 4, minnumtowers = 2)
phfCoincFilter3Th4 = phfCoincFilter2Th4.clone(threshold = 4, minnumtowers = 3)
phfCoincFilter4Th4 = phfCoincFilter2Th4.clone(threshold = 4, minnumtowers = 4)
phfCoincFilter5Th4 = phfCoincFilter2Th4.clone(threshold = 4, minnumtowers = 5)
